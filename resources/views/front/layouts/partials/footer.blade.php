...
<footer class="footer bg-light pt-3">
                    ...
                    <div class="widget pb-3 mb-lg-4">
                        ...
                        <ul class="widget-list">
                            @if (isset($pages) && $pages)
                                ...
                                @endforeach
                            @endif
                            <li class="widget-list-item"><a class="widget-list-link" href="{{ route('faq') }}">{{ __('front/common.faq') }}</a>
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="col-lg-4 mb-lg-0 mb-4">
                    <div class="widget pb-3 mb-lg-2">
                        ...
                        <ul class="widget-list">
                            ...
                            <li class="widget-list-item"><a class="widget-list-link" href="{{ route('kontakt') }}"><i class="ci-mail me-1" style="visibility: hidden;"></i> {{ __('front/ricekakis.kontaktirajte_nas') }}</a>
                        </ul>
                    </div>
                    <div>
    ...
    <div class="bg-darker px-lg-5 py-3">
        <div class="d-sm-flex justify-content-between align-items-center mx-auto px-3" >
            <div class="fs-sm text-white  text-center text-sm-start py-3">Rice Kakis Asian Store © {{ __('front/ricekakis.sva_prava') }}. Web by <a class="text-white" href="https://www.agmedia.hr/usluge/izrada-web-shopa/" title="Izrada web shopa - AG media" target="_blank" rel="noopener">AG media</a></div>
            <div class="widget widget-links widget-light pt-1 text-center text-md-end">
                ...
                <img src="{{ asset('media/cards/visa.svg') }}" loading="lazy" alt="Visa" class="d-inline-block" style="width: 55px; margin-right: 3px;" width="55" height="35"> <img src="{{ asset('media/cards/maestro.svg') }}" loading="lazy" alt="Maestro" class="d-inline-block" style="width: 55px; margin-right: 3px;" width="55" height="35"> <img src="{{ asset('media/cards/mastercard.svg') }}" loading="lazy" alt="MasterCard" class="d-inline-block" style="width: 55px; margin-right: 3px;" width="55" height="35">
                <img src="{{ asset('media/cards/diners.svg') }}" alt="Diners" class="d-inline-block" loading="lazy" style="width: 55px; margin-right: 3px;" width="55" height="35">
            </div>
        </div>
    </div>
</footer>
