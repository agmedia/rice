...
<div class="language">
    ...
    <div class="dropdown hover-dropdown">
        <button class="dropdown-toggle btn btn-sm btn-default px-1 ps-3 text-white" type="button" data-bs-toggle="dropdown"><img class="lang" style="width:16px" src="{{ asset('media/flags/' . session('locale') . '.png') }}" alt="{{ \Illuminate\Support\Str::upper(current_locale()) }}"> {{ \Illuminate\Support\Str::upper(current_locale()) }} </button>
                    ...
                    <li>
                        @if (isset($page) && $page->id == 5 )
                            <a class=" @if (current_locale() == $lang->code) active @endif" href="{{ \Mcamara\LaravelLocalization\Facades\LaravelLocalization::getLocalizedURL($lang->code, route('index'), [], true) }}">
                                <img class="lang" style="width:16px;margin-left:5px" src="{{ asset('media/flags/'.Str::lower($lang->code).'.png') }}" alt="{{ $lang->title->{current_locale()} }}">
                        ...
                        @endif
                            ...
                            @if (isset($blog) && $frontblogs )
                                <a class=" @if (current_locale() == $lang->code) active @endif" href="{{ \Mcamara\LaravelLocalization\Facades\LaravelLocalization::getLocalizedURL($lang->code, route('catalog.route.blog'), [], true) }}">
                                    <img class="lang" style="width:16px;margin-left:5px" src="{{ asset('media/flags/'.Str::lower($lang->code).'.png') }}" alt="{{ $lang->title->{current_locale()} }}">
                                    {{ $lang->title->{current_locale()} }}
                                </a>
                            @endif
                            ...
                            @if (isset($recepti) && $receptin )
                                <a class=" @if (current_locale() == $lang->code) active @endif" href="{{ \Mcamara\LaravelLocalization\Facades\LaravelLocalization::getLocalizedURL($lang->code, route('catalog.route.recepti'), [], true) }}">
                                    <img class="lang" style="width:16px;margin-left:5px" src="{{ asset('media/flags/'.Str::lower($lang->code).'.png') }}" alt="{{ $lang->title->{current_locale()} }}">
                                    {{ $lang->title->{current_locale()} }}
                                </a>
                            @endif
                            ...
                            @if (isset($faq)  )
                                <a class=" @if (current_locale() == $lang->code) active @endif" href="{{ \Mcamara\LaravelLocalization\Facades\LaravelLocalization::getLocalizedURL($lang->code, route('faq'), [], true) }}">
                                    <img class="lang" style="width:16px;margin-left:5px" src="{{ asset('media/flags/'.Str::lower($lang->code).'.png') }}" alt="{{ $lang->title->{current_locale()} }}">
                                    {{ $lang->title->{current_locale()} }}
                                </a>
                            @endif
                        ...
                        <!-- -->
                        @if (isset($page) && $page->id != 5)
                            <a class=" @if (current_locale() == $lang->code) active @endif" href="{{ \Mcamara\LaravelLocalization\Facades\LaravelLocalization::getLocalizedURL($lang->code, route('catalog.route.page', ['page' => $page->translation($lang->code)->slug]), [], true) }}">
                                <img class="lang" style="width:16px;margin-left:5px" src="{{ asset('media/flags/'.Str::lower($lang->code).'.png') }}" alt="{{ $lang->title->{current_locale()} }}">
                                {{ $lang->title->{current_locale()} }}
                            </a>
                        @endif
