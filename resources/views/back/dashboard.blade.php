                ...
                <div class="col-md-12">
                    <div class="block block-rounded block-mode-hidden">
                        ...
                        <div class="block-content">
                            ...
                            <br>
                            <a href="{{ route('set.url') }}" class="btn btn-hero-sm btn-rounded btn-hero-danger mb-3 mr-3">Set Products URL</a>
                                ...
                                @forelse ($orders->sortByDesc('id') as $order)
                                    <tr>
                                        ...
                                        <td class="font-size-base">
                                            <span class="badge badge-pill badge-{{ $order->status->color }}">{{ $order->status->title->{current_locale()} ?? $order->status->title }}</span>
                                        </td>
            ...
            <div class="row">
                ...
                <div class="col-md-6 d-flex flex-column">
                    <div class="block block-rounded">
                        ...
                        <div class="block-content block-content-full block-content-sm bg-body-light fs-sm text-center">
                            <a class="fw-medium" href="{{ route('products') }}?quantity=inactive">
